...
d3.csv("https://raw.githubusercontent.com/holtzy/data_to_viz/master/Example_dataset/5_OneCatSevNumOrdered_wide.csv").then(function(data) {
    ...
    // What to do when one group is hovered: TODO: Add a hovering effect by reducing the opacity of all areas, except the one you are currently hovering over. Remember that you have given each area a class based on it's index
